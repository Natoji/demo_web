            ...
            <ul class="divide-y divide-gray-200">
              <li v-for="item in cartItems" :key="item.id" class="p-4 flex flex-col sm:flex-row sm:items-center">
                ...
                <div class="flex-grow">
                  ...
                  <p class="text-gray-600 text-sm">{{ item.price.toFixed(2) }} VNĐ each</p>
                </div>
                ...
                <div class="flex items-center mt-4 sm:mt-0">
                  ...
                  <span class="mx-4 font-medium">{{ (item.price * item.quantity).toFixed(2) }} VNĐ</span>
          ...
          <div class="bg-white rounded-lg shadow-md overflow-hidden sticky top-4">
            ...
            <div class="p-4 space-y-4">
              <div class="flex justify-between">
                ...
                <span class="font-medium">{{ subtotal.toFixed(2) }} VNĐ</span>
              </div>
    ...
    setup() {
      ...
      const loadCart = async () => {
        try {
          ...
          console.log('Processed cart items:', cartItems.value)
        } catch (err) {
      ...
      const updateQuantity = async (id, newQuantity) => {
        ...
        try {
          ...
          const response = await cartAPI.updateCartItem(user.id, id, { quantity: newQuantity });
      ...
      const removeItem = async (id) => {
        try {
          ...
          const response = await cartAPI.removeFromCart(user.id, id);
