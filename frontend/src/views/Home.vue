          ...
          <div class="p-4">
            ...
            <div class="flex justify-end mt-4">
              <button
                ...
                class="w-full bg-rose-600 text-white py-2 px-4 rounded-lg hover:bg-rose-700 flex items-center justify-center gap-2"
              >
  ...
  setup() {
    ...
    const addToCart = async (product) => {
      try {
        ...
        const cartData = {
          menuItemId: Number(product.id), // Assuming your product ID maps to menuItemId in the cart
          quantity: 1,
        };
